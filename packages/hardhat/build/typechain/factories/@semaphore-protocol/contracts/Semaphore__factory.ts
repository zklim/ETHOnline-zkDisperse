...
import type {
  Semaphore,
  SemaphoreInterface,
} from "../../../@semaphore-protocol/contracts/Semaphore";
...
export class Semaphore__factory extends ContractFactory {
  constructor(...args: SemaphoreConstructorParams) {
    if (isSuperArgs(args)) {
      ...
      super(
        _abi,
        Semaphore__factory.linkBytecode(linkLibraryAddresses),
        signer
      );
    }
  }
  ...
  override deploy(
    ...
    return super.deploy(_verifier, overrides || {}) as Promise<Semaphore>;
  }
  ...
  override attach(address: string): Semaphore {
    return super.attach(address) as Semaphore;
  }
  override connect(signer: Signer): Semaphore__factory {
    return super.connect(signer) as Semaphore__factory;
  }
